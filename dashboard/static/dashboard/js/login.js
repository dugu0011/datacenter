$(document).ready(function() {
    ...
    $("#mp_view_button").bind("mousedown touchstart", function() {
        $("#masterpassword").attr("type", "text");
    }),
    $("#mp_view_button").bind("mouseup touchend", function() {
...
function submitForm(){
    ...
    if(document.getElementById("yourEmail").value.trim()==="" && document.getElementById("yourEmail").value!==null){
